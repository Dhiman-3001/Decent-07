...
export function WhatsAppButton() {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-full mr-3 px-3 py-2 bg-foreground dark:bg-card text-background dark:text-foreground text-sm rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none border border-border/50">
        Chat with us
      </span>
