...
export function InfrastructureHero() {
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      <div className="absolute inset-0 bg-linear-to-br from-blue-50 via-indigo-50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950" />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            className="w-20 h-20 mx-auto mb-8 rounded-2xl bg-linear-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-xl"
          >
